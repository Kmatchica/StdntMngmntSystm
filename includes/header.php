...
<html lang="en">
  <head>
    ...
    <title>MILC Student Management System|| Update About Us</title>
    <!-- plugins:css -->
...
<!-- <div id="loading"></div> -->
 ...
 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          ...
          <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img src="assets/images/logo_dark.png" alt="logo" /></a>
        </div><?php
